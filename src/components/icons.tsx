...
export const GoogleLogo = (props: React.SVGProps<SVGSVGElement>) => (
  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <path
      fill="#4285F4"
      d="M21.35 11.1H12.18v2.8h4.99c-.3 1.8-1.6 3.1-3.4 3.1-2.1 0-3.8-1.7-3.8-3.8s1.7-3.8 3.8-3.8c1.1 0 2.1.5 2.8 1.2l2.2-2.2C17.2 5.2 14.8 4 12.18 4c-4.4 0-8 3.6-8 8s3.6 8 8 8c4.6 0 7.7-3.2 7.7-7.7 0-.6-.1-1.2-.2-1.8z"
    />
  </svg>
)
